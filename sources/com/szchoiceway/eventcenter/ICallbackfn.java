...
public interface ICallbackfn extends IInterface {
    public static final String DESCRIPTOR = "com.szchoiceway.eventcenter.ICallbackfn";
    ...
    public static abstract class Stub extends Binder implements ICallbackfn {
        ...
        public Stub() {
            attachInterface(this, ICallbackfn.DESCRIPTOR);
        }
        ...
        public static ICallbackfn asInterface(IBinder iBinder) {
            ...
            IInterface queryLocalInterface = iBinder.queryLocalInterface(ICallbackfn.DESCRIPTOR);
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            if (i == 1598968902) {
                parcel2.writeString(ICallbackfn.DESCRIPTOR);
                return true;
            } else if (i != 1) {
                return super.onTransact(i, parcel, parcel2, i2);
            } else {
                parcel.enforceInterface(ICallbackfn.DESCRIPTOR);
        ...
        private static class Proxy implements ICallbackfn {
            ...
            public void notifyEvt(int i, int i2, int i3, byte[] bArr, String str) throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken(ICallbackfn.DESCRIPTOR);
                    obtain.writeInt(i);
                    obtain.writeInt(i2);
                    obtain.writeInt(i3);
