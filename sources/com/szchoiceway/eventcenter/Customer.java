...
public class Customer {
    ...
    public static int getIModeSet(Context context) {
        return SysProviderOpt.getInstance(context).getRecordInteger(SysProviderOpt.KESAIWEI_SYS_MODE_SELECTION, 16);
    }

    public static int getUIIndex(Context context) {
        int recordInteger = SysProviderOpt.getInstance(context).getRecordInteger(SysProviderOpt.KESAIWEI_SYS_MODE_SELECTION, 16);
        if (recordInteger != 35) {
            if (recordInteger == 34) {
    ...
    public static int getCarFactoryIndex(Context context) {
        ...
        if (SysProviderOpt.getInstance(context).getRecordInteger(SysProviderOpt.KESAIWEI_SYS_MODE_SELECTION, 16) == 34) {
            return 0;
        }
    ...
    public static boolean isSmallResolution(Context context) {
        String recordValue = SysProviderOpt.getInstance(context).getRecordValue(SysProviderOpt.KSW_UI_RESOLUTION, BuildConfig.FLAVOR);
    ...
    public static boolean isCopilot(Context context) {
        return SysProviderOpt.getInstance(context).getRecordInteger(SysProviderOpt.KESAIWEI_SYS_MODE_SELECTION, 16) == 39;
    }
}
