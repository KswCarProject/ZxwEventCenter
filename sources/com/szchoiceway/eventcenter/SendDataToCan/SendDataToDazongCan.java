...
public class SendDataToDazongCan extends BroadcastReceiver {
    private static final String TAG = "SendDataToDazongCan";
    protected EventService mContext = null;
    protected boolean register = false;

    public SendDataToDazongCan(EventService eventService) {
