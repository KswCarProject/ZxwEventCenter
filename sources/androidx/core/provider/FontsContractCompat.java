...
public class FontsContractCompat {
    ...
    public static android.graphics.Typeface getFontSync(final android.content.Context r2, final androidx.core.provider.FontRequest r3, final androidx.core.content.res.ResourcesCompat.FontCallback r4, final android.os.Handler r5, boolean r6, int r7, final int r8) {
        ...
        L_0x0061:
            ...
            monitor-enter(r4)
            androidx.collection.SimpleArrayMap<java.lang.String, java.util.ArrayList<androidx.core.provider.SelfDestructiveThread$ReplyCallback<androidx.core.provider.FontsContractCompat$TypefaceResult>>> r5 = sPendingReplies     // Catch:{ all -> 0x0092 }
            boolean r6 = r5.containsKey(r0)     // Catch:{ all -> 0x0092 }
            if (r6 == 0) goto L_0x0079
            if (r3 == 0) goto L_0x0077
            java.lang.Object r5 = r5.get(r0)     // Catch:{ all -> 0x0092 }
            java.util.ArrayList r5 = (java.util.ArrayList) r5     // Catch:{ all -> 0x0092 }
            r5.add(r3)     // Catch:{ all -> 0x0092 }
        L_0x0077:
            monitor-exit(r4)     // Catch:{ all -> 0x0092 }
            return r2
        L_0x0079:
            if (r3 == 0) goto L_0x0086
            java.util.ArrayList r6 = new java.util.ArrayList     // Catch:{ all -> 0x0092 }
            r6.<init>()     // Catch:{ all -> 0x0092 }
            r6.add(r3)     // Catch:{ all -> 0x0092 }
            r5.put(r0, r6)     // Catch:{ all -> 0x0092 }
        L_0x0086:
            monitor-exit(r4)     // Catch:{ all -> 0x0092 }
