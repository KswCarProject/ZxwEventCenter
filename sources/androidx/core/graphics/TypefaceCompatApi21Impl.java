...
class TypefaceCompatApi21Impl extends TypefaceCompatBaseImpl {
    ...
    public android.graphics.Typeface createFromFontInfo(android.content.Context r4, android.os.CancellationSignal r5, androidx.core.provider.FontsContractCompat.FontInfo[] r6, int r7) {
        ...
        L_0x0006:
            ...
            android.net.Uri r6 = r6.getUri()     // Catch:{ IOException -> 0x0065 }
            java.lang.String r0 = "r"
            android.os.ParcelFileDescriptor r5 = r7.openFileDescriptor(r6, r0, r5)     // Catch:{ IOException -> 0x0065 }
        ...
        L_0x0061:
            r5.close()     // Catch:{ IOException -> 0x0065 }
        L_0x0064:
            throw r6     // Catch:{ IOException -> 0x0065 }
        L_0x0065:
            return r1
        */
