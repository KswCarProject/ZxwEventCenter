...
public class TypefaceCompatApi26Impl extends TypefaceCompatApi21Impl {
    ...
    public android.graphics.Typeface createFromFontInfo(android.content.Context r11, android.os.CancellationSignal r12, androidx.core.provider.FontsContractCompat.FontInfo[] r13, int r14) {
        ...
        L_0x0006:
            ...
            android.net.Uri r14 = r13.getUri()     // Catch:{ IOException -> 0x005d }
            java.lang.String r0 = "r"
            android.os.ParcelFileDescriptor r11 = r11.openFileDescriptor(r14, r0, r12)     // Catch:{ IOException -> 0x005d }
            if (r11 != 0) goto L_0x0026
            if (r11 == 0) goto L_0x0025
            r11.close()     // Catch:{ IOException -> 0x005d }
        L_0x0025:
            return r2
        L_0x0026:
        ...
        L_0x0054:
            r11 = move-exception
            r12.addSuppressed(r11)     // Catch:{ IOException -> 0x005d }
            goto L_0x005c
        L_0x0059:
            r11.close()     // Catch:{ IOException -> 0x005d }
        L_0x005c:
            throw r13     // Catch:{ IOException -> 0x005d }
        L_0x005d:
            return r2
        L_0x005e:
