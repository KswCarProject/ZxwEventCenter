...
public final class AppCompatDrawableManager {
    ...
    private android.graphics.drawable.Drawable getCachedDrawable(android.content.Context r5, long r6) {
        /*
            ...
            monitor-enter(r0)
            java.util.WeakHashMap<android.content.Context, androidx.collection.LongSparseArray<java.lang.ref.WeakReference<android.graphics.drawable.Drawable$ConstantState>>> r1 = r4.mDrawableCaches     // Catch:{ all -> 0x002f }
            java.lang.Object r1 = r1.get(r5)     // Catch:{ all -> 0x002f }
            androidx.collection.LongSparseArray r1 = (androidx.collection.LongSparseArray) r1     // Catch:{ all -> 0x002f }
            r2 = 0
