...
final class AppCompatColorStateListInflater {
    ...
    public static android.content.res.ColorStateList createFromXml(android.content.res.Resources r4, org.xmlpull.v1.XmlPullParser r5, android.content.res.Resources.Theme r6) throws org.xmlpull.v1.XmlPullParserException, java.io.IOException {
        ...
        L_0x0016:
            ...
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.appcompat.content.res.AppCompatColorStateListInflater.createFromXml(android.content.res.Resources, org.xmlpull.v1.XmlPullParser, android.content.res.Resources$Theme):android.content.res.ColorStateList");
    }
    ...
    private static android.content.res.ColorStateList inflate(android.content.res.Resources r17, org.xmlpull.v1.XmlPullParser r18, android.util.AttributeSet r19, android.content.res.Resources.Theme r20) throws org.xmlpull.v1.XmlPullParserException, java.io.IOException {
        ...
        L_0x001f:
            ...
            goto L_0x00ad
        L_0x0032:
            int[] r7 = androidx.appcompat.R.styleable.ColorStateListItem
            r8 = r17
            r9 = r20
            android.content.res.TypedArray r7 = obtainAttributes(r8, r9, r0, r7)
            int r10 = androidx.appcompat.R.styleable.ColorStateListItem_android_color
            r11 = -65281(0xffffffffffff00ff, float:NaN)
            int r10 = r7.getColor(r10, r11)
            r11 = 1065353216(0x3f800000, float:1.0)
            int r12 = androidx.appcompat.R.styleable.ColorStateListItem_android_alpha
            ...
            goto L_0x0064
        L_0x0056:
            int r12 = androidx.appcompat.R.styleable.ColorStateListItem_alpha
            boolean r12 = r7.hasValue(r12)
        ...
        L_0x006f:
            ...
            if (r15 == r2) goto L_0x0090
            int r2 = androidx.appcompat.R.attr.alpha
            if (r15 == r2) goto L_0x0090
            int r2 = r14 + 1
        ...
        L_0x0094:
            ...
            int r10 = r2.length
        L_0x009f:
            int[] r3 = androidx.appcompat.content.res.GrowingArrayUtils.append((int[]) r3, (int) r6, (int) r7)
            java.lang.Object[] r2 = androidx.appcompat.content.res.GrowingArrayUtils.append((T[]) r4, (int) r6, r2)
            r4 = r2
            int[][] r4 = (int[][]) r4
            int r6 = r6 + 1
            goto L_0x00b1
        ...
        L_0x00b4:
            ...
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.appcompat.content.res.AppCompatColorStateListInflater.inflate(android.content.res.Resources, org.xmlpull.v1.XmlPullParser, android.util.AttributeSet, android.content.res.Resources$Theme):android.content.res.ColorStateList");
    }
