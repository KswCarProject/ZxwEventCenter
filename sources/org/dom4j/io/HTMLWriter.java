...
public class HTMLWriter extends XMLWriter {
    ...
    private String lastText = BuildConfig.FLAVOR;
    ...
    /* access modifiers changed from: protected */
    public void loadOmitElementCloseSet(Set<String> set) {
        set.add("AREA");
        set.add("BASE");
        set.add("BR");
        set.add("COL");
    ...
    public void setOmitElementCloseSet(Set<String> set) {
        ...
        if (set != null) {
            ...
            for (String next : set) {
                if (next != null) {
                    this.omitElementCloseSet.add(next.toUpperCase());
                }
            }
        }
    }
    ...
    public void setPreformattedTags(Set<String> set) {
        ...
        if (set != null) {
            for (String next : set) {
                if (next != null) {
                    this.preformattedTags.add(next.toUpperCase());
                }
            }
        }
    }
    ...
    public void writeElement(Element element) throws IOException {
        ...
        if (isPreformattedTag(qualifiedName)) {
            ...
            try {
                ...
                outputFormat.setIndent(BuildConfig.FLAVOR);
