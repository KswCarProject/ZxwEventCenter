...
public class SAXEventRecorder extends DefaultHandler implements LexicalHandler, DeclHandler, DTDHandler, Externalizable {
    ...
    public void replay(ContentHandler contentHandler) throws SAXException {
        ...
        for (SAXEvent next : this.events) {
            switch (next.event) {
                case 1:
                    contentHandler2.processingInstruction((String) next.getParm(0), (String) next.getParm(1));
                    break;
                case 2:
                    contentHandler2.startPrefixMapping((String) next.getParm(0), (String) next.getParm(1));
                    break;
                case 3:
                    contentHandler2.endPrefixMapping((String) next.getParm(0));
                    break;
                case 4:
                ...
                case 6:
                    ...
                    List<String[]> list = (List) next.getParm(3);
                    if (list != null) {
                        for (String[] strArr : list) {
                            attributesImpl.addAttribute(strArr[0], strArr[1], strArr[2], strArr[3], strArr[4]);
                        }
                    }
                    contentHandler2.startElement((String) next.getParm(0), (String) next.getParm(1), (String) next.getParm(2), attributesImpl);
                    break;
                case 7:
                    contentHandler2.endElement((String) next.getParm(0), (String) next.getParm(1), (String) next.getParm(2));
                    break;
                case 8:
                    contentHandler2.characters((char[]) next.getParm(0), ((Integer) next.getParm(1)).intValue(), ((Integer) next.getParm(2)).intValue());
                    break;
                case 9:
                    ((LexicalHandler) contentHandler2).startDTD((String) next.getParm(0), (String) next.getParm(1), (String) next.getParm(2));
                    break;
                case 10:
                    ((LexicalHandler) contentHandler2).endDTD();
                    break;
                case 11:
                    ((LexicalHandler) contentHandler2).startEntity((String) next.getParm(0));
                    break;
                case 12:
                    ((LexicalHandler) contentHandler2).endEntity((String) next.getParm(0));
                    break;
                case 13:
                ...
                case 14:
                    ...
                    break;
                case 15:
                    ((LexicalHandler) contentHandler2).comment((char[]) next.getParm(0), ((Integer) next.getParm(1)).intValue(), ((Integer) next.getParm(2)).intValue());
                    break;
                case 16:
                    ((DeclHandler) contentHandler2).elementDecl((String) next.getParm(0), (String) next.getParm(1));
                    break;
                case 17:
                    ((DeclHandler) contentHandler2).attributeDecl((String) next.getParm(0), (String) next.getParm(1), (String) next.getParm(2), (String) next.getParm(3), (String) next.getParm(4));
                    break;
                case 18:
                    ((DeclHandler) contentHandler2).internalEntityDecl((String) next.getParm(0), (String) next.getParm(1));
                    break;
                case 19:
                    ((DeclHandler) contentHandler2).externalEntityDecl((String) next.getParm(0), (String) next.getParm(1), (String) next.getParm(2));
                    break;
                default:
                    throw new SAXException("Unrecognized event: " + next.event);
            }
        }
    }
        ...
        if (attributes != null && attributes.getLength() > 0) {
            ...
            for (int i = 0; i < attributes.getLength(); i++) {
                ...
                if (localName.startsWith(XMLNS)) {
                    ...
                    List list = this.prefixMappings.get(qName);
                    if (list == null) {
                        list = new ArrayList();
