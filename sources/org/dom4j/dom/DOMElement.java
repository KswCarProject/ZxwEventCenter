...
public class DOMElement extends DefaultElement implements Element {
    ...
    public String getAttribute(String str) {
        ...
        return attributeValue != null ? attributeValue : BuildConfig.FLAVOR;
    }
    ...
    public Attribute attribute(String str, String str2) {
        ...
        for (Attribute next : attributeList) {
            if (str2.equals(next.getName()) && (((str == null || str.length() == 0) && (next.getNamespaceURI() == null || next.getNamespaceURI().length() == 0)) || (str != null && str.equals(next.getNamespaceURI())))) {
                return next;
            }
        }
        return null;
